...
export default function Hero() {
  const [profileImage, setProfileImage] = useState("https://res.cloudinary.com/dshznc4xx/image/upload/a_hflip/v1738228843/MiguelPC_mfdchi.jpg");

  useEffect(() => {
    const updateImage = () => {
      if (window.innerWidth <= 768) {
        setProfileImage("https://res.cloudinary.com/dshznc4xx/image/upload/v1737478718/MiguelPC_d1f2ux.jpg");
      } else {
        setProfileImage("https://res.cloudinary.com/dshznc4xx/image/upload/a_hflip/v1738228843/MiguelPC_mfdchi.jpg");
      }
    };
  ...
  return (
    <header className={styles.hero}>
      ...
      <div className={styles.container}>
        <Image src={profileImage} alt="Miguel Bellota" width={200} height={200} className={styles.image} />
