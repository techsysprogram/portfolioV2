...
export default function Skills() {
  return (
    <section className={styles.skills}>
      ...
      <h3 className="subtitle highlight">Frameworks & Librairies</h3>
      ...
      <h3 className="subtitle highlight">Langages de Programmation</h3>
      <div className={styles.skillsGrid}>
      ...
      {/* Section Backend */}
      <h3 className="subtitle highlight">Bases de Données & Backend</h3>
      <div className={styles.skillsGrid}>
      ...
      <h3 className="subtitle highlight">Outils & DevOps</h3>
      <div className={styles.skillsGrid}>
